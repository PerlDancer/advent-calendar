...
the community, our L<http://www.perldancer.org/irc|IRC chanel> has 87 people
...
L<http://www.perldancer.org/dancefloor|Dancefloor (Websites using Dancer)> page.


=head2 Many more plugins to make life easy

Many more valuable and useful plugins have been released - a search on MetaCPAN
for L<https://metacpan.org/search?q=Dancer%3A%3APlugin|Dancer::Plugin::> gives
73 results.
...
L<http://tools.ietf.org/html/rfc5789|RFC 5789>, allowing clients to perform a
...
has been submitted, but, at the time of writing, has not been accepted or
responded to:
...
The L<http://p3rl.org/Dancer#send_file|send_file> keyword can now be used to
...
The L<http://p3rl.org/Dancer#send_file|send_file> keyword now supports PSGI
...
causing it to honour the X_FORWARDED_PROTOCOL, X_FORWARDED_HOST etc env vars.
