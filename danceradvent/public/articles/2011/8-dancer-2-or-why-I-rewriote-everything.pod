...
If you've been following a bit what happened in the Perl Dancer ecosystem
recently, you might be aware that a complete rewrite of the core is on the way.

I haven't advertised what I did, what happened and what is the plan, this
...
place. It was in summer 2009, I was working at Yoolink at that time and we did
use a lot the Ruby language.

I discovered the Sinatra micro-framework at that time and found it really
exciting. After a quick glance, it appeared that there was nothing similar in
the Perl ecosystem at that time, so I decided it would be an interesting 
challenge to port it to Perl.

First Dancer prototype was born.

The prototype evolved quickly and afetr a couple of months, the project was up
...
and had quite a good reputation of being very easy to use and making web development
fun with Perl.
...
the way and gives you all the freedom to think at one thing: your application.

But, you know the drill, perfect software does not exist, there is always
somethign we can do better. In the case of Dancer, there was a couple of design
decisions that needed to be taken care of.

Actually, when I took the time to think about it, I realized there were two
major drawbacks in the design that prevented Dancer from continuing its growth.
...
the Law of Demeter, in order to ensure sane classes/methods hierarchy.
...
apps collisions, multiple engines per app, per-apps settings, etc).
...
with Matt Trout on IRC, in order to do a brainstorming about that new "design
experiment".

Matt sounded encouraging and provided lots of useful and enlightened
suggestions to help me start.

One of his suggestion was to use Moo to get a complete Moose-ish object system
for the core yet fast and lightweight. 
That happened to be one of the more helpful choice to enforce a
better design.
