=head1 Flexible exceptions handling with Dancer::Exception
...
comparison just fine, so you can just C<print $exception>
...
new exception flavours, raise these exceptions, and catch and test them.
...
understand the effect, one must see the function C<_login>, which shows how to
