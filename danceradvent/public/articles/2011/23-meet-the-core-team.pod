...
He is a software engineer working at L<Linkfluence|http://linkfluence.net/>, 
where most of his time is spent working on a feed aggregator, collecting data 
from various web services, and handling the scalability of the architecture.

He is also a member of L<Paris.pm|http://paris.mongueurs.net/>, where he 
organises the technical meetings for the group.
