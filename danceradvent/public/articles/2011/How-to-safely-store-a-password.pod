...
minutes. If your password is less than 8 characters and is stored as
unsalted SHAE<ndash>1 (A common scenario) - it is effectively plain
text.
...
If you want to do everything manually, you can use the venerable L set
