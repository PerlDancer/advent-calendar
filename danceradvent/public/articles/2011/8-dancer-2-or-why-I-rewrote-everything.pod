...
The repository is public on L<Github|http://github.com/PerlDancer/Dancer2>, you're
...
To get a quick teaser about the interal changes we have, let's enable the core
debug messages:
