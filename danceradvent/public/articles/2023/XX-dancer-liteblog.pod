...
The 2023 edition of this Dancer Advent Calendar is the perfect chance fo
The opportunity of this Dancer Advent Calendar, edition 2023, is perfect for me
...
At the time of this wrtiting, there isn't any web admin available, but this will
come in future releases. 
But as you will see, it is super easy to get started with it.

Before LiteBlog can work its magic, you need a Dancer2 app. Generate it:

  $ dancer2 gen -a my_app

Then, run the LiteBlog scaffolder fro mwithin the application directory:
...
(that can be defined in your liteblog's settings) can also defined their own
routes.
...
ou'll be greeted with a splash screen:
...
Now, you have Activities cards enabled on the home and a nice article that you
can read thanks o the Blog widget. Everything is explained in that article, that
you can freely edit.
...
publish, go in your articles/ folder (it has been created by the scaffolder),
...
Finally, you can now create the C<content.md> file, which, as it names suggests,
should be written in Markdown format and will be used as the actual content of
the article.

Again, the easiest way to get started is to edit the scaffolded article provided
...
Show your support on CPAN: L<https://metacpan.org/dist/Dancer2-Plugin-LiteBlog>
