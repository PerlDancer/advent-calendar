...
paying bills, etc. is time we aren't spending advancing Dancer.
On the other hand, TPRF has infrastructure in place to manage non-profit
donations with the goal of supporting the Perl and Raku communities.

We are happy to announce we're piloting a partnership program that, if
deemed successful, can be offered to other projects in the Perl and Raku
communities.
...
the safety and betterment of our community, which we believe is a good
model for a CoC to be adopted by the greater community.
