...
=item * The previous article on I<Dancer Internals>

=item * The previous article on I<Writing a new Dancer serializer>

=item * The following article on I<Writing a new Dancer session backend>
