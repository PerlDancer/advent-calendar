...
or similar then there's a problem.
...
Dancer unofficially supports Websockets and other streaming processes via
...
and initialises the environment in the background.
...
This article has been written by nmani (Naveen Manivannan 
C<< <nmani@nashresearch.com> >>) for the Perl Dancer Advent Calendar 2010.
