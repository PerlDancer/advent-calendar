...
feature set limited on purpose.
...
We want to serve light HTML content when accessed by a mobile
...
The subroutine bound to our C<is_mobile_device> keyword should do one simple
...
We now want to change the layout whenever a request is served for a
...
L<GitHub|https://github.com/sukria/Dancer-Plugin-MobileDevice>.
...
L<Dancer|http://perldancer.org> and uses C<Dancer::Plugin::MobileDevice> to
