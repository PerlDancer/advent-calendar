...
jump to L<this article|http://advent.perldancer.org/2011/8> of the previous
advent calendar.
...
So what will be 2013? You already know it right? My bet goes on the "Dancer 2
...
L<http://github.com/PerlDancer/Dancer 2/> and you can grab the source like so:

    git clone https://github.com/PerlDancer/Dancer 2.git
...
globals are evil. That was a mistake I did in the early stage of development of
Dancer 1, we lived with it, I think pretty well, but Dancer 2 needed to go a
...
In your application, create a git submodule in vendor/Dancer 2:
  ...
  $ cd MyProject
  $ git submodule add https://github.com/PerlDancer/Dancer 2.git vendor/Dancer 2
...
And while we're at it, see L<on this
commit|https://github.com/PerlDancer/Dancer-Plugin-Feed/commit/1399073ebc192c02c8eddfc83ebf6fc07675191b>
how simple it was to port Dancer::Plugin::Feed (which is used by the Advent
Calendar app) to Dancer 2.
