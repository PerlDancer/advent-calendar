...
With Dancer 2 you can declare route handlers in new manner so that they can be
...
how it works, how to write your own and how to use them in your app.

=head2 The concept

The idea is simple: what about a generic route, a route that would make sense in
many application, a route that is agnostic of the business logic the app? Plugin
