...
There have been many trivial improvements and bugfixes, but a few more notable
...
L<https://speakerdeck.com/loonypandora/documentation-for-fun-and-profit|Documentation For Fun and Profit>
...
address: L<mailto:dancer-users@dancer.pm>.  The old address redirects to the new
list.
