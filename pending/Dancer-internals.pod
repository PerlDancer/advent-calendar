...
B<core>, B<engines> and B<plugins>. We'll see what are the differences between
those three parts and what are the concepts behind them.
...
backends available on the CPAN. This showscases one of the ideas behind Dancer's
