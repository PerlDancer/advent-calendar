...
CGI is arguably the most common web programming model. Not because it's
...
Every time a browser makes a requests, the server runs the CGI script and gets
...
In L<Catalyst>, for example, a request to I<http://myapp/view/articles/30> will
be dispatched using the namespace I<MyAppName::View> (as long as our app is
under a I<MyApp> namespace) to the file I<View.pm>, to the function I<articles>
