...
Your log will become colorful according to this default configuration:
...
documented in detail in L<Dancer2::Core::Role::Logger>. You can put it in with the other configuration.
...
like to see additional features, please feel free to open a ticket on github.
