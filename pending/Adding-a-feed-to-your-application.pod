...
In the advent calendar application, each articles is stored in a POD file on
...
And to finish, our route to return the content of the RSS feed. This route get
the B<year> as argument, and ask for the list of articles of this year
...
In the previous exemple, we've seen how to create a RSS feed. But maybe some of
your users would have prefered an Atom feed, so we will let the decide what
