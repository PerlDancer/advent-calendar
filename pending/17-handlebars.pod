...
for some deep wisdom here about why and how I created Dancer2::Template::Handlebars.
...
If you have a bit of HTML your Dancer application is generating, or storing in a database, you can cause those
to be passed along with a "triple-stache":  C<{{{ generated_html_field }}}>.
