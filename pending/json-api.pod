...
(very) new plugin in town, L<Dancer2::Plugin::ApiJson> to help. 

The first, and biggest thing that Dancer2::Plugin::ApiJson provides is a way
...
develop into a DBIx-specific set of C<Dancer2::Plugin::ApiJson>. Who knows...
