...
In the previous article, we saw how to develop a plugin. We have
written in our example a plugin named L<Dancer::Plugin::MobileDevice>,
we'll see in this one how to test it.

In this article you will learn how to use the L<Dancer::Test> module for
...
through all the possible ways but that's beyond the scope of this
article.
...
Proofreading and typo-fixing for this article have been made by XXX,
YYY
