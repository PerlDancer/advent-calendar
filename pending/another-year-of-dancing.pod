...
The C<send_file> keyword will now also stream the response asynchrnously
...
=item * New documnetation

We have revamped our documentation.

The original documentation had irrelvant parts from Dancer 1 which no
longer apply to Dancer 2, oudated components, unclear and confusing
...
We have become better at identifyinig memory leaks and resolved a few
