...
keywords with C<register> and register the plugin itslef when done with
C<register_plugin>.
...
We now have our layouts waiting to be used in the F<t/views/layouts>
...
As you can imagine, I've written Dancer::Plugin::MobileDevice and
