...
guide is intended to show you, at a high level, how to get involved
in the community, and things you can do to help further Dancer development
and the community. Part 2 of this will focus on the gory details: how to set
up a development environment for Dancer, and more.
...
core framework, a plugin - B<please> report it! While you can report it in
...
environment on the channel at all times, and users of C<#dancer> would generally
agree that it's a pretty friendly place to be.

To get started, all you have to do is point your favorite IRC client to
C<irg.perl.org#dancer> and you're off and running! Ask a question, answer
a question, pitch your plugin idea... there are a number of ways for you 
to get involved.
...
document. The Core Team takes violations of this policy very, very seriously.

=head2 Sending a Documentation Patch

=head2 Taking an Issue from the GitHub Queue

=head2 Proposing/Implementing a Feature
...
The next article in this series will give you the gory details, such as
working with L<Dist::Zilla>, how the core team decides on what gets 
included, and more!
