...
While we do not need to restart our web server when changing images or
template files, we still require it when changing our application code.
...
The L<Plack::Middleware::Refresh> module allows us to ...
...
There are other solutions that possibly provide more flexibility.
