...
core can be fatpacked. We do this by having the core require only
pure-Perl modules and only optionally use XS modules to improve speed.

This means that as long as your application is also pure-Perl, you could
create a single file with your application and all of Dancer2.
...
is using L<MIME::Types> which has a database all of MIME types and helps
...
co-worker/colleague/enemies a single file that has everything in it,
