...
=item * Messages get sent to the template

Messages are automatically sent to the template, in an array called C<messages>. By default,
not all messages are sent to the template, as you probably don't want the user
